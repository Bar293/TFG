...
\definecolor{biomedica}{RGB}{210,180,240}   % Ingeniería Biomédica
...
% Másteres
	...
	\else \if\IDtitulo M % Ingenieria geologica
		...
		\newcommand{\colortexto}{blanco}
	\else \if\IDtitulo N % Ingeniería Biomédica
		% Logos
		\newcommand{\logoFacultadPortada}{include/logos-universidad/LogoEPSBlanco}
		\newcommand{\logoGradoPortada}{include/logos-titulaciones/LogoBiomedicaColor}
		\newcommand{\logoGrado}{include/logos-titulaciones/LogoBiomedicaNegro}
		% Texto
		\newcommand{\miGrado}{Grado en Ingeniería Biomédica}
		\newcommand{\tipotrabajo}{Trabajo Fin de Grado}
		% Color
